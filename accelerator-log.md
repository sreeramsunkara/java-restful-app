...
```json
{
  ...
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=sreeramsunkara&repo=java-restful-app",
  "buildTool" : "maven",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#exposeOpenAPIEndpoint) evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [DESCRIPTION_VAL->, OWNER_VAL->, SYSTEM_VAL->]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=sreeramsunkara&repo=java-restful-app'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug docker-compose.yml didn't match [**/workload.yaml] -> excluded
